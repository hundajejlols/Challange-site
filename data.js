...
const GRACZE = [
  {
    ...
    foto: "img/gracz3.jpg",
    tier: "PLATINUM", dywizja: 3, lp: 47,
    wygrane: 23, przegrane: 13,
    kda: "3.5",
    mainChamp: "Kindred",
    rola: "Jungle",
    motto: "Wjeżdżam po swoje.",
    historia: [["IRON",4,0],["PLATINUM",3,47]],
  },
  {
    imie: "G2 菲烏特克馬利",
  ...
  },
  {
    ...
    riotId: "レイピスト#BBWDH",
    foto: "img/gracz1.jpg",
    tier: "PLATINUM", dywizja: 4, lp: 30,
    wygrane: 16, przegrane: 5,
    kda: "3.2",
    mainChamp: "Poppy",
    rola: "Jungle",
    motto: "Cisza przed burzą.",
    historia: [["IRON",4,0],["PLATINUM",4,30]],
  },
  {
    imie: "Narciarz123",
